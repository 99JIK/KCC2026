"""Prompt templates for KCC-version generation strategies.

All four strategies (zero-shot, few-shot, proposed, proposed+few-shot) share
the same SYSTEM_PROMPT for the final XML synthesis step. Coverage information
is never injected into any prompt - the validator only emits structural
feedback used by STRUCTURAL_REPAIR_TEMPLATE.
"""
